...
# Kennis over github
Voor dit transcriptomicsproject is GitHub ingericht als centrale omgeving voor het beheren van de onderzoeksgegevens, analysescripts en resultaten. De repository bevat de verschillende bestanden die tijdens het onderzoek zijn gebruikt, waardoor de data en scripts overzichtelijk bij elkaar staan en eenvoudig terug te vinden zijn. Door gebruik te maken van versiebeheer en branches konden wijzigingen in scripts afzonderlijk worden bijgehouden en getest, zonder de oorspronkelijke versie te overschrijven. Hierdoor bleef het onderzoeksproces overzichtelijk en konden eerdere versies indien nodig worden teruggehaald.
